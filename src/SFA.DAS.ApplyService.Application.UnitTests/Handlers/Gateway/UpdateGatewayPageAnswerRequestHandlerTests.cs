...
namespace SFA.DAS.ApplyService.Application.UnitTests.Handlers.Gateway
{
    ...
    public class UpdateGatewayPageAnswerRequestHandlerTests
    {
        ...
        public void SetUp()
        {
            ...
            _handler = new UpdateGatewayPageAnswerRequestHandler(_repository.Object, _gatewayRepository.Object, _auditService.Object, Mock.Of<IUnitOfWork>());
        }
        ...
        public async Task Handle_Updates_Existing_GatewayPageAnswer(string clarificationComments)
        {
            ...
            _gatewayRepository.Verify(x => x.UpdateGatewayPageAnswer(It.Is<GatewayPageAnswer>(a => 
