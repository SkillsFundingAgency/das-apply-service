...
namespace SFA.DAS.ApplyService.Application.UnitTests.Handlers.OrganisationsHandlerTests
{
    ...
    public class UpdateOrganisationHandlerTests
    {
        ...
        public void TestSetup()
        {
            ...
            _handler = new UpdateOrganisationHandler(_organisationRepository.Object, _organisationAddressesRepository.Object);
        }

        [Test]
        public async Task UpdateOrganisationHandler_Updates_Organization_if_it_already_exists()
        {
