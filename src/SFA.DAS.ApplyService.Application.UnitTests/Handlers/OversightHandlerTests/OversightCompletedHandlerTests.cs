...
namespace SFA.DAS.ApplyService.Application.UnitTests.Handlers.OversightHandlerTests
{
    ...
    public class OversightCompletedHandlerTests
    {
        ...
        public void Setup()
        {
            ...
            OversightReviewQueries.Setup(r => r.GetCompletedOversightReviews(null,null,null)).ReturnsAsync(new CompletedOversightReviews());
        ...
        public void Check_pending_results_are_as_expected()
        {
            ...
            OversightReviewQueries.Setup(r => r.GetCompletedOversightReviews(null,null,null)).ReturnsAsync(completedApplications);

            var result = CompletedHandler.Handle(new GetOversightsCompletedRequest(null,null,null), new CancellationToken()).GetAwaiter().GetResult();
