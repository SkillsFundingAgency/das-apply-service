...
{
    [TestFixture]
    public class GetCompletedAppealOutcomesHandlerTests
    {
        protected Mock<IOversightReviewQueries> OversightReviewQueries;
        protected GetCompletedAppealOutcomesHandler CompletedHandler;
        ...
        public void Setup()
        {
            ...
            CompletedHandler = new GetCompletedAppealOutcomesHandler(OversightReviewQueries.Object);
        }
        ...
        public void Check_completed_results_are_as_expected()
        {
            ...
            var result = CompletedHandler.Handle(new GetCompletedAppealOutcomesRequest(null, null, null), new CancellationToken()).GetAwaiter().GetResult();
