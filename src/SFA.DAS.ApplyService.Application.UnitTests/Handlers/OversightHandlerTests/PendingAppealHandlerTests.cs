...
{
    [TestFixture]    
    public class PendingAppealHandlerTests
    {
        protected Mock<IOversightReviewQueries> OversightReviewQueries;
        protected GetPendingAppealHandler PendingHandler;
        ...
        public void Setup()
        {
            ...
            PendingHandler = new GetPendingAppealHandler(OversightReviewQueries.Object);
        }
        ...
        public void Check_pending_results_are_as_expected()
        {
            ...
            var result = PendingHandler.Handle(new GetPendingAppealRequest(null, null, null), new CancellationToken()).GetAwaiter().GetResult();
