...
namespace SFA.DAS.ApplyService.InternalApi.UnitTests
{
    public class OrganisationSummaryControllerGetCompanyDirectorsTests
    {
        ...
        [Test]
        public void get_no_directors_if_tag_doesnt_exist()
        {
        ...
        public void get_list_of_company_directors_submitted(string name1, string dateOfBirth1 , string name2, string dateOfBirth2)
        {
        ...
        [Test]
        public void get_no_directors_if_apply_data_doesnt_exist()
        {
            var result = (OkObjectResult)_controller.GetDirectorsFromCompaniesHouse(_applicationId).Result;
        ...
        public void get_list_of_company_directors_from_apply(string name1, DateTime? dateOfBirth1, string name2, DateTime? dateOfBirth2)
        {
