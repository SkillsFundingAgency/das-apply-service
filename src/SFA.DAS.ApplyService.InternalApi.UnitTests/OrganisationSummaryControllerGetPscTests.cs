...
namespace SFA.DAS.ApplyService.InternalApi.UnitTests
{
    public class OrganisationSummaryControllerGetPscTests
    {
        ...
        [Test]
        public async Task get_no_people_in_control_if_tag_doesnt_exist()
        {
            var result = await _controller.GetPscsFromSubmitted(_applicationId) as OkObjectResult;
        ...
        public async Task get_list_of_pscs_submitted(string name1, string dateOfBirth1, string name2, string dateOfBirth2)
        {
        ...
        [Test]
        public async Task get_no_psc_if_apply_data_doesnt_exist()
        {
            var result = await _controller.GetPscsFromCompaniesHouse(_applicationId) as OkObjectResult;
        ...
        public async Task get_list_of_pscs_from_apply(string name1, DateTime? dateOfBirth1, string name2, DateTime? dateOfBirth2)
        {
