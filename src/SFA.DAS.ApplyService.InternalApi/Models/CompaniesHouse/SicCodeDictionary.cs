...
namespace SFA.DAS.ApplyService.InternalApi.Models.CompaniesHouse
{
    public class SicCodeDictionary : IReadOnlyDictionary<string, string>
    {
        ...
        // This was grabbed from https://raw.githubusercontent.com/companieshouse/api-enumerations/develop/constants.yml
        private static IReadOnlyDictionary<string, string> _items = new Dictionary<string, string>()
        {
