namespace SFA.DAS.ApplyService.InternalApi.Types
{
    public static class GatewayFields
    {
        ...
        public const string ApplicationSubmittedOn = "ApplicationSubmittedOn";
        public const string GatewayReviewStatus = "GatewayReviewStatus";
        public const string SourcesCheckedOn = "SourcesCheckedOn";
        ...
        public const string TypeOfOrganisation = "TypeOfOrganisation";
    }
}
