...
namespace SFA.DAS.ApplyService.Web.ViewModels.Roatp
{
    public class SubmitApplicationViewModel
    {
        ...
        [Range(typeof(bool), "true", "true", ErrorMessage = "Tell us if you confirm that all the answers and uploads in this application are accurate and to the best of your knowledge")]
