...
namespace SFA.DAS.ApplyService.Web.Services
{
    public class OverallOutcomeService : IOverallOutcomeService
    {
        ...
        public async Task<ApplicationSummaryViewModel> BuildApplicationSummaryViewModel(Apply application, FinancialReviewDetails financialReviewDetails, string emailAddress)
        {
